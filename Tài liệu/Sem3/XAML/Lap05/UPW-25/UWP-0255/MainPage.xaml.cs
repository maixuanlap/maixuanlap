...
namespace UWP_0255
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void MyAutoSuggestBox_Changed(AutoSuggestBox sender, AutoSuggestBoxTextChangedEventArgs args)
        {
            var autoSuggestBox = (AutoSuggestBox)sender;
            var filterd = selectionItems.Where(p => p.StartsWith(autoSuggestBox.Text)).ToArray();
            autoSuggestBox.ItemsSource = filterd;
        }
    }
}
