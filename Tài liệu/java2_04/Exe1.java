...
public class Exe1 {
    ...
    try(
        ...
        System.out.println("===========================================================");
        String strSelect1 = "select title, price from books WHERE author = 'Codelean VN'";
        ...
        System.out.println("===========================================================");
        String strSelect2 = "select id, title, author, price, qty from books WHERE author = 'Codelean VN' OR price >= 30 ORDER BY price desc, id ASC";
