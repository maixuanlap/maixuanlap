    ...
    public static void main(String[] args) {
        ...
        while(n != SENTINEL){
            if(n == 1){
                ...
                System.out.println("Enter new contact name:mai xuan lap ");
                String name = scanner.next();
                System.out.println("Enter phone number:012345678 ");
                String phone = scanner.next();
                Contact contact = new Contact(name,phone);
                contactList.addContact(contact);
            }else if(n == 3){
                System.out.println("Enter existing contact name:maixuanlap ");
                String name = scanner.next();
                Contact oldContact = contactList.searchContact(name);
                System.out.print("Enter new contact name: ");
                String newName = scanner.next();
                System.out.print("Enter phone number: 012345678");
