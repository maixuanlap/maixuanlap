...
<head>
	...
	<script src="{{URL::asset('js/mobile.js')}}js/mobile.js" type="text/javascript"></script>
</head>
<body>
	<div id="page">
		<div id="header">
			<div>
				<a href="index.blade.php" class="logo"><img src="{{URL::asset('images/logo.png')}}images/logo.png" alt=""></a>
				<ul id="navigation">
					<li class="selected">
